...
short_pos = open("twitter_samples/positive_tweets.txt","r", encoding='utf-8', errors='replace').read()
short_neg = open("twitter_samples/negative_tweets.txt","r", encoding='utf-8', errors='replace').read()
...
saved_word_features = open("pickled_algos/word_features5l.pickle", "wb")
